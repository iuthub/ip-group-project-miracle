...
//        VarDumper::dump($gallery, 12, true);die;

        $sliders = Sliders::find()->all();
// VarDumper::dump($sliders, 12, true);


//        $courses = Courses::find()->all();
//        VarDumper::dump($courses,12,true);

        $prices = Prices::find()->all();
//        VarDumper::dump($prices, 12, true);
    ...
    public function actionContact()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            try {
                ...
                Yii::$app->session->setFlash('error', 'Hatolik sodir bo`ldi. ' . $e->getMessage());
            }
            return $this->refresh();
        }
